  ...
  return (
    <aside className="space-y-6 lg:sticky lg:top-24">
      ...
      <section className="rounded-2xl bg-brand-950 text-white p-5 shadow-card">
        ...
        <Link
          to="/dashboard"
          className="inline-flex items-center justify-center w-full bg-white text-slate-700 border border-slate-200 rounded-xl px-4 py-2.5 hover:bg-slate-50 transition-all duration-150"
        >
          Try vidThix Free
        </Link>
      </section>
