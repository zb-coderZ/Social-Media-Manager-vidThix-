...
const Toast = ({ id, message, type, duration }) => {
  ...
  return (
    <div
      className={`flex items-center gap-3 px-4 py-3 rounded-xl border ${styles.bg} shadow-lg backdrop-blur-xl transition-all duration-200 hover:shadow-xl min-w-[320px] max-w-md`}
    >
