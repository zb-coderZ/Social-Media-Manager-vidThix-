    ...
    <>
      ...
      <div className="p-6 border-b dark:border-navy-800 border-gray-200">
        <Link to="/dashboard" className="flex items-center gap-2 group">
          <div className="w-10 h-10 bg-gradient-to-br from-indigo-600 to-cyan-500 dark:from-indigo-600 dark:to-cyan-500 from-indigo-400 to-cyan-400 rounded-xl flex items-center justify-center transform group-hover:scale-105 transition-transform duration-200 dark:shadow-glow shadow-md">
      ...
      <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
        {SIDEBAR_ITEMS.map((item) => {
          const Icon = LucideIcons[item.icon] || LucideIcons.Square;
      ...
      <div className="p-4 border-t dark:border-navy-800 border-gray-200">
        <div className="flex items-center gap-3 px-4 py-3 rounded-xl dark:bg-navy-800/60 dark:hover:bg-navy-700/60 bg-gray-100 hover:bg-gray-200 transition-colors duration-200 cursor-pointer">
          <div className="w-10 h-10 bg-gradient-to-br from-indigo-600 to-cyan-500 dark:from-indigo-600 dark:to-cyan-500 from-indigo-400 to-cyan-400 rounded-full flex items-center justify-center dark:shadow-glow shadow-md">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs dark:text-gray-500 text-gray-600 truncate">demo@vidthix.com</p>
          </div>
        </div>
      </div>
    </>
